...
router.post("/", requireWorkspaceMemberFromBody, requireEditorFromContext, createNote);
...
router.get("/workspace/:workspaceId/search", requireWorkspaceMember, searchWorkspaceNotes);
...
router.put("/:id", requireResourceWorkspaceMember(Note), requireEditorFromContext, updateNote);
